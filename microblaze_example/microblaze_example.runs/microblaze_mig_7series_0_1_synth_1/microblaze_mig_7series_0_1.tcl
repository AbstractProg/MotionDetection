...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir C:/Github/MotionDetection/microblaze_example/microblaze_example.runs/microblaze_mig_7series_0_1_synth_1 -new_name microblaze_mig_7series_0_1 -ip [get_ips microblaze_mig_7series_0_1]]

if { $cached_ip eq {} } {

synth_design -top microblaze_mig_7series_0_1 -part xc7a100tcsg324-1 -mode out_of_context

#---------------------------------------------------------
# Generate Checkpoint/Stub/Simulation Files For IP Cache
#---------------------------------------------------------
catch {
 write_checkpoint -force -noxdef -rename_prefix microblaze_mig_7series_0_1_ microblaze_mig_7series_0_1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ microblaze_mig_7series_0_1_stub.v
 lappend ipCachedFiles microblaze_mig_7series_0_1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ microblaze_mig_7series_0_1_stub.vhdl
 lappend ipCachedFiles microblaze_mig_7series_0_1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ microblaze_mig_7series_0_1_sim_netlist.v
 lappend ipCachedFiles microblaze_mig_7series_0_1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ microblaze_mig_7series_0_1_sim_netlist.vhdl
 lappend ipCachedFiles microblaze_mig_7series_0_1_sim_netlist.vhdl

 config_ip_cache -add -dcp microblaze_mig_7series_0_1.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips microblaze_mig_7series_0_1]
}

rename_ref -prefix_all microblaze_mig_7series_0_1_

write_checkpoint -force -noxdef microblaze_mig_7series_0_1.dcp
