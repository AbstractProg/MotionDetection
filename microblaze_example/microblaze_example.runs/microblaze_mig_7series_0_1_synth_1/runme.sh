...
HD_PWD='C:/Github/MotionDetection/microblaze_example/microblaze_example.runs/microblaze_mig_7series_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_mig_7series_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_mig_7series_0_1.tcl
