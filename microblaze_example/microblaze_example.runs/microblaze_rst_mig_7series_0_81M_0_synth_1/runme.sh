...
HD_PWD='C:/Github/MotionDetection/microblaze_example/microblaze_example.runs/microblaze_rst_mig_7series_0_81M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_rst_mig_7series_0_81M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_rst_mig_7series_0_81M_0.tcl
