...
################################################################
# This is a generated script based on design: bd_87ec
#
...
CONFIG.READ_WRITE_MODE {READ_WRITE} \
CONFIG.SSC000_ROUTE {0b10} \
CONFIG.SSC001_ROUTE {0b01} \
CONFIG.SSC002_ROUTE {0b00} \
...
CONFIG.C_AUX_RST_WIDTH {1} \
  ...
  connect_bd_net -net psr_aclk_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins swbd_aresetn] [get_bd_pins psr_aclk/interconnect_aresetn]
