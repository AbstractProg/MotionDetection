...
#
# Generated by export_simulation on Thu Aug 09 18:59:17 +0300 2018
#
################################################################################
...
switch to the './Reference_frame.sh' script.

./Reference_frame.sh -reset_run
...
./Reference_frame.sh -noclean_files

For more information on the script, please type './Reference_frame.sh -help'.
