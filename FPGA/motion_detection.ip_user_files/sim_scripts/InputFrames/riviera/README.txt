...
#
# Generated by export_simulation on Sun Aug 12 14:00:26 +0300 2018
#
################################################################################
...
switch to the './InputFrames.sh' script.

./InputFrames.sh -reset_run
...
./InputFrames.sh -noclean_files

For more information on the script, please type './InputFrames.sh -help'.
