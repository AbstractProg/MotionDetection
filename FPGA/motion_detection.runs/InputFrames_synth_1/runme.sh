...
HD_PWD='C:/programming/GitHub/MotionDetection/FPGA/motion_detection.runs/InputFrames_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InputFrames.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InputFrames.tcl
