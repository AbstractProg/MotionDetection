...
HD_PWD='C:/programming/GitHub/MotionDetection/FPGA/motion_detection.runs/Reference_frame_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reference_frame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reference_frame.tcl
