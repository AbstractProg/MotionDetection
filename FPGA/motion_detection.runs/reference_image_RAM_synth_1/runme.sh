...
HD_PWD='C:/Github/MotionDetection/FPGA/motion_detection.runs/reference_image_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reference_image_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reference_image_RAM.tcl
