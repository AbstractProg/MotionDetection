...
HD_PWD='C:/Github/MotionDetection/microblaze_example_vhdl/microblaze_example_vhdl.runs/microblaze_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_axi_smc_0.tcl
