...
xvlog_opts="-m64 --relax -L smartconnect_v1_0 -L xil_defaultlib"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb microblaze.wdb xsim.dir)
